...
@dataclass
class CustomResponseOutputText:
    text: str
    """The text content of the output message."""

    citations: list[str]
    """The citations for the text content. This is a list of strings that represent the
    citations for the text content.
    """

    type: Literal["text"]
    """The type of the output message. Always `text`."""

    annotations: list[dict[str, Any]]
    """The annotations for the text content. This is a list of dictionaries that represent
    the annotations for the text content.
    """


@dataclass
class CustomResponseOutputMessage:
    id: str
    """The unique ID of the output message."""

    content: list[CustomResponseOutputMessage]
